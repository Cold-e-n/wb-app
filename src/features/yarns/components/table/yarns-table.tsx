...
import { yarnsTableColumns as columns } from './yarns-table-columns'
import type {
  FilterFn,
  SortingState,
...
const fuzzyFilter: FilterFn<Yarn> = (row, columnId, value, addMeta) => {
  // Rank the item
...
const route = getRouteApi('/_auth/yarns')
